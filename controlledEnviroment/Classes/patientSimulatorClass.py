from Classes.LetterToCharactersClass import LetterToCharacters
import random
import datetime
...
class PatientSimulatorClass():
    def __init__(self):
        ...
        self.path = "~/../inData/WordFiles/ThousandWords.txt"
    ...
    def readOutWord(self, givenWord, OutputWord):
        fileHandle = open("~/../inData/PatientFiles/patient"+self.fileAppend+".csv", "a")
